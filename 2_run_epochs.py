...
behav_var = {'TNT' : ['Cond1', 'Cond2', 'Image.OnsetTime', 'Black.RESP', 'ImageCentre', 'ImageFond'],
             'Attention' : ['Cond1', 'Cond2', 'Cond3', 'Cond4', 'Image.OnsetTime', 'Image.RESP', 'Image.RT', 'ImageCentre', 'ImageFond']}
...
def run_epochs(subject, task):
    ...
    *subject: string
    ...
    evoked_clean = epochs_clean.average().crop(-0.2, 3.0).apply_baseline(baseline=(None, 0))
