...
def extract_frequencies(subject, freqs, decim):
    ...
    * subject: str
    ...
    this_tfr = tfr_morlet(epochs, freqs, n_cycles=n_cycles,
                          n_jobs=6, average=False, decim=decim,
                          return_itc=False)
    
    this_tfr = this_tfr.crop(-0.2, 3.0)
    this_tfr = this_tfr.apply_baseline(mode='mean',
                                       baseline=(-0.2, 0))
    
    np.save(root + '/TNT/Multitaper_NoThink/' + subject + '_No-Think_TF.npy', this_tfr._data)
# =============================================================================
# %%
# =============================================================================
total = []
